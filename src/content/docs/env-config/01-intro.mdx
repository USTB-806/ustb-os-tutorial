...
首先，我们建议你下载轻量级代码编辑器 VSCode, 并安装 Docker 插件，请阅读 [VSCode 下载与安装](../vscode/) 部分。



其次，我们需要你的操作系统支持 Docker ，如果你之前没有安装过 Docker ，请先参考 [**Docker 安装**](../docker/) 章节进行 Docker 的配置。 如果你之前有使用过 Docker ，则可以跳过这一步。
